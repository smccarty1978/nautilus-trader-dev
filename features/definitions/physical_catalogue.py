"""Physical feature catalogue: the historical output-alias registry.

Registered through ``research_workflow/capabilities_index.d/feature_definitions.yaml``
and merged by ``features.registry``; nothing imports this module by name.  It is the
compatibility catalogue of physical output aliases -- lifecycle and alias identity for active
resolution come from the canonical authority bundle, not from here.
"""
