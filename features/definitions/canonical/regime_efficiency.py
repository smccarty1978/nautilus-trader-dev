"""Canonical feature definition record: ``regime_efficiency``.
...
# `regime` remains in the historical parameter schema for promotion-record compatibility, but no
# active completed-bar provider consumes it; an EMPTY value domain makes every supplied value fail closed.
DEFINITION = FeatureDefinition(
    name='regime_efficiency',
    status='provisional',
