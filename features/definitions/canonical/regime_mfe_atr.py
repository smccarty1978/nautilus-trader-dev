"""Canonical feature definition record: ``regime_mfe_atr``.
...
# current-context (timeframe 5m) = maximum favorable excursion SO FAR of the in-progress 5m regime,
# from the completed-5m running extreme up to T. Distinct from the completed-regime (context=prior)
# statistic; no forming-5m state.
