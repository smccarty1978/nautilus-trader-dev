"""Canonical feature definition record: ``distance_to_completed_range_high_atr``.
...
DEFINITION = FeatureDefinition(
    name='distance_to_completed_range_high_atr',
    status='provisional',
    ...
    parameter_schema=('reference_timeframe', 'bar_state'),
    supported_timeframes=('1m', '5m', '5s'),
    supported_parameter_values={
        'reference_timeframe': ('5m',),
        'bar_state': ('completed',),
    },
    required_parameters=('reference_timeframe',),
