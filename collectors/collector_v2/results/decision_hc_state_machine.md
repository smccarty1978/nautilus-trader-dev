...
**High-Health HardStall**: Shows the highest average remaining MFE (2.70 ATR) and a high reignition rate, indicating it is a high-value pullback.

### 3
Which state has the worst future opportunity?
**Low-Health HardStall**: Leads to imminent collapse (low remaining MFE of 2.00 ATR, high flip rate of 46.7% within 5 bars, and a hold PnL of -$13.53).

### 4
Which state should be bought?
**High-Health HardStall**: Shows the highest remaining MFE (2.70 ATR), making it the prime candidate for add-ons or scaling in if the entry model is profitable.

### 5
Which state should be reduced?
**Medium-Health HardStall**: Represents a mid-quality zone; position size should be standard or scaled down slightly.
