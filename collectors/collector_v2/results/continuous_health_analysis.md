...
You are exactly correct: **DETER is a lossy compression of the real signal.** 
...
2. **Continuous Trailing Stop**:
   * Instead of a static warning, construct a trailing exit threshold that is a function of the continuous $hC$ level and slope. For example, exit if:
