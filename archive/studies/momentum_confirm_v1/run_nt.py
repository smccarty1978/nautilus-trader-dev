"""Run momentum-confirm NT strategy."""
...
from nt_strategy import (  # noqa
    MomentumConfirmStrategy, MomentumConfirmConfig)
...
def main():
    ...
    out_dir = Path(
        f"studies/momentum_confirm_v1/results/"
        f"nt_{args.mode}_{args.year}")
