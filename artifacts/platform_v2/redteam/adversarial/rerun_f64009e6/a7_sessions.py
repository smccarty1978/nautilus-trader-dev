...
# RERUN-ADAPT (f64009e6): session_windows now REJECTS halt_end < rth_close (SessionHaltInvalidError),
# so the original unguarded call aborts the script. Wrapped; a raise is the BLOCKED outcome.
try:
