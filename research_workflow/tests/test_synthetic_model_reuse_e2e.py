...
def test_synthetic_closed_model_reuse_without_runtime_code_change(tmp_path):
    ...
    authored={"study":{"id":"source","type":"bespoke","description":"synthetic"},"operation":{"kind":"train_evaluate"},"bespoke":{"reason":"Synthetic target-runtime acceptance fixture","unsupported_contract_element":"ordered barrier fixture","canonical_type_considered":"flip_prediction","reusable_extension_considered":"target runtime"},"instrument":{"symbol":"NQ"},"population":{"prevailing_regime":"bearish"},"target":{"type":"classification","direction":"bullish","conditions":[{"id":"primary","kind":"ordered_barrier","forward_outcome_id":"path","barrier_id":"b"}],"required_forward_outcomes":[{"id":"path","entry_reference":"next_bar_open","horizon_seconds":10,"max_tracking_seconds":10,"max_gap_seconds":1,"ordered_barriers":[{"id":"b","favorable_atr":1.,"adverse_atr":1.,"horizon_seconds":10}]}]},"chronology":{"train":[2021],"dev":[2022],"prohibited":[2025,2026]},"features":{},"model":{},"execution":{"runtime":"nautilustrader"}}
    ...
    source.joinpath("artifacts").mkdir(exist_ok=True); source.joinpath("artifacts/study_closure.json").write_text(json.dumps({"schema_version":1,"study_id":"source","status":"CLOSED","outcome":"DIAGNOSTIC_NEGATIVE","terminal_decision":"no_signal"}))
