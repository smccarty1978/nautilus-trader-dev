...
def closed_fixture(tmp_path):
    ...
    # final evidence must be produced from the study's plan and cite the analysis (B3, 2026-09-10)
    (art / "experiment_analysis_v2.json").write_text('{"metric":0.7,"plan_sha256":"fixture"}', encoding="utf-8")
    (art / "analysis_decision.json").write_text('{"outcome":"COMPLETE","terminal_decision":"DONE","rationale":"fixture","evidence":["artifacts/experiment_analysis_v2.json"]}', encoding="utf-8")
