...
def test_collector_path_ordered_contract_cannot_execute_flip_labels():
    ...
    obj._track_pending({"observation_ts":0,"regime_start_ns":0,"regime_direction":1,"checkpoint_index":0,"entry_price":100.,"target_frozen_atr":2.}, 0)
    obj._resolve_ordered_barriers({"ts":1_000_000_000,"high":103.,"low":100.,"gap":False}, now_ts=11_000_000_000)
...
def test_ordered_pending_candidate_survives_regime_flip_then_resolves_ohlc():
    ...
    obj._resolve_ordered_barriers({"ts":2_000_000_000,"high":103.,"low":100.,"gap":False},now_ts=2_000_000_000)
    assert obj.observations_log[0]["disposition"] == "LABELED_POSITIVE"
