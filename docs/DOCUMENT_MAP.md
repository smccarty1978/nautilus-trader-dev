...
| `docs/design/GROUND_UP_RESEARCH_PLATFORM.md` | PROPOSAL revision 6 (2026-09-16, not implemented; Phase 0 experimentation approved by reviews 4-5): ground-up single-engine research/training/backtest architecture for a new repo; revised after red-team reviews 1-5 (change log at top maps every finding to its section) |
