"""Phase 1 driver for F2_CONFIRMED: build the corrected weakness
checkpoint atlas from the full 2021-2026 NT collection in
_work/nt_raw/, and write this study's required Phase 1 deliverables
under results/ and audit/.
"""
...
def main():
    ...
    t0 = time.time()
    atlas = build_atlas(WORK_ROOT, "F2_CONFIRMED")
    ...
    with open(report_path, "w") as f:
        f.write("# F2_CONFIRMED Atlas Integrity Report\n\n")
