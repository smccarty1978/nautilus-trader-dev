# Model card — `long_bullish_flip_top50`
...
`TOP50` — 50 raw features,
50 model columns.
Order is **significant** and frozen in `feature_order.csv`
(`feature_order_sha256 = 5a2b1a70ebaff75e…`).
...
|---|---:|---:|
| AUC | 0.67062 | 0.6396 |
| Top-decile flip rate | 0.50294 | 0.53382 |
...
| `manual_formula` | 2025 | 163,397 | 3.988e-12 | 1e-09 | **PASS** |

ONNX: `model.onnx` present, parity PASS (max_abs_diff 2.155e-07 vs joblib).
...
- `intercept.json` — `intercept = -1.1269756415071344`
...
model = joblib.load("artifacts/long_bullish_flip_top50/model.joblib")
order = pd.read_csv("artifacts/long_bullish_flip_top50/feature_order.csv")["feature_name"].tolist()
```
