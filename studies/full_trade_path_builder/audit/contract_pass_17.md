# Contract Check — 1.00 ATR First-Signal Stop Study
...
| Sole policy change | Configured stop is 1.00 ATR; other accepted rules unchanged | PASS |
...
| Trade-level evidence | 5,836 rows with event, return, excursion, censor fields | PASS |
...
| Report | Dynamic 1.00 labels, methods, results, limitations, verdict | PASS |
