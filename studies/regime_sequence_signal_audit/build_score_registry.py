...
def main():
    print("Building score registry...")
    
    # Answers to the 6 questions
    answers = """## Answers to Score Questions:
...
"""
    ...
    # Registry table
    registry_table = """# score/model registry
...
"""
    ...
    md_path = OUT_DIR / "score_registry.md"
    with open(md_path, "w") as f:
        f.write(registry_table + "\n" + answers)
        
    print(f"Score registry written to {md_path}")
