...
description: Read-only compliance reviewer. Owns deliverable completeness, seal integrity, terminal-label reachability, and train/serve contract compliance against an explicit frozen SPEC.
