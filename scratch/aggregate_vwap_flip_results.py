"""Aggregate Strategy F (Raw Flip Entry) Nautilus Trader backtest results and verify parity with offline simulation"""
...
DIR_PREFIX = "nq_kmeans_4_s0_sl1p5_ancflip_minatr15p0_vwapF_qty2_ptr2p0"
...
def main():
    ...
    print("\n" + "="*100)
    print("  STRATEGY F (RAW FLIP) NAUTILUS TRADER BACKTEST VERIFICATION: VWAP-CONDITIONED EXITS")
    print("="*100)
