"""Task 3: Cluster Robustness Analysis."""
import pandas as pd
import numpy as np
...
def main():
    print("Loading baseline trades for Task 3...")
    all_trades = []
    ...
    for y in OOS_YEARS:
        ...
        df["year"] = y
        # Convert timestamp to ET date/month
    ...
    print(f"Total OOS trade records loaded: {len(oos_df)}")
    
    # 1. Monthly P&L breakdown
    ...
    # Exclusion 2: Symmetrically drop Top 1 profit month in 2023
    ...
    # Exclusion 3: Drop Top 1 profit month in 2025
    ...
    # Exclusion 4: Drop Top 1 & 2 profit months in 2025
    ...
    # Exclusion 5: Drop BOTH Aug-Oct 2024 loss cluster AND top 2025 profit month 1
