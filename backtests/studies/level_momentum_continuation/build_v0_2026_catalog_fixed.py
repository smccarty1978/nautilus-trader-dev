"""Build v0_2026 NT catalog with FIXED 1m resample (closed='left').

Mirror of build_v0_2025_catalog_fixed.py for the 2026 YTD data.
Output: data/catalog/NQ_v0_2026_fixed/
"""
...
def main():
    t0 = time.time()
    out_dir = Path("data/catalog/NQ_v0_2026_fixed")
    if out_dir.exists():
    ...
    raw_path = Path("data/raw/NQ_v0_1s_2026_ytd.parquet")
