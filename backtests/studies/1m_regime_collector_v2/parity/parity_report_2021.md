...
- Collector features: `studies\1m_regime_collector_v2\results\v2_feature_snapshots_2021.parquet`
- Collector labels:   `studies\1m_regime_collector_v2\results\v2_outcome_labels_2021.parquet`
...
========================================================================
  Total fillable checkpoints: 963
  All-match: 963 / 963  (100.00%)
  Mismatches by kind:
    MFE grid: 0 rows (max delta 0.00e+00)
    MAE grid: 0 rows (max delta 0.00e+00)
    Bracket: 0 rows
  RTH: n=483  all-match 483/483 (100.00%)
  ETH: n=480  all-match 480/480 (100.00%)
