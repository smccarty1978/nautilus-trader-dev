...
- Collector features: `studies\1m_regime_collector_v2\results\v2_feature_snapshots_2025.parquet`
- Collector labels:   `studies\1m_regime_collector_v2\results\v2_outcome_labels_2025.parquet`
- Sample size: 1000 (RTH 500, ETH 500)
- Random seed: 42
- Harness elapsed: 29.3s
...
========================================================================
  Total fillable checkpoints: 959
  All-match: 959 / 959  (100.00%)
  Mismatches by kind:
    MFE grid: 0 rows (max delta 0.00e+00)
    MAE grid: 0 rows (max delta 0.00e+00)
    Bracket: 0 rows
  RTH: n=473  all-match 473/473 (100.00%)
  ETH: n=486  all-match 486/486 (100.00%)
