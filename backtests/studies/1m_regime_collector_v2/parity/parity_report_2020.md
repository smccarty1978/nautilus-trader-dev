...
- Collector features: `studies\1m_regime_collector_v2\results\v2_feature_snapshots_2020.parquet`
- Collector labels:   `studies\1m_regime_collector_v2\results\v2_outcome_labels_2020.parquet`
- Sample size: 1000 (RTH 500, ETH 500)
- Random seed: 42
- Harness elapsed: 30.9s
...
========================================================================
  Total fillable checkpoints: 967
  All-match: 967 / 967  (100.00%)
  Mismatches by kind:
    MFE grid: 0 rows (max delta 0.00e+00)
    MAE grid: 0 rows (max delta 0.00e+00)
    Bracket: 0 rows
  RTH: n=486  all-match 486/486 (100.00%)
  ETH: n=481  all-match 481/481 (100.00%)
